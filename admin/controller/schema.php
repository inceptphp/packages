 ...
 */
$this('http')->get('/admin/system/schema/search', function (
 ...
 */
$this('http')->get('/admin/spa/system/schema/create', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/schema/create/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('http')->post('/admin/spa/system/schema/create', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  //----------------------------//
  // 2. Process Data
  $this('event')->call('system-schema-create', $data, $response);
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/field', function(
  RequestInterface $request,
  ResponseInterface $response
) {
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/field/save', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/system/schema/export', function(
  RequestInterface $request,
  ResponseInterface $response
) {
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/system/schema/export/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //get the schema folder path
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/schema/import', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/import', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //get the schema folder path
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/schema/remove/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/remove/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/schema/restore/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/restore/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/schema/update/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/schema/update/:name', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  //----------------------------//
  // 2. Process Data
  $this('event')->call('system-schema-update', $data, $response);
