 ...
 */
$this('http')->get('/admin/system/fieldset/search', function (
 ...
 */
$this('http')->get('/admin/spa/system/fieldset/create', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/fieldset/create/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param ResponseInterface $response
 */
$this('http')->post('/admin/spa/system/fieldset/create', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  //----------------------------//
  // 2. Process Data
  $this('event')->call('system-fieldset-create', $data, $response);
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/field', function(
  RequestInterface $request,
  ResponseInterface $response
) {
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/field/save', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/system/fieldset/export', function(
  RequestInterface $request,
  ResponseInterface $response
) {
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/system/fieldset/export/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //get the fieldset folder path
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/fieldset/import', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/import', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //get the fieldset folder path
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/fieldset/remove/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/remove/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/fieldset/restore/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/restore/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->get('/admin/spa/system/fieldset/update/:name', function(
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
 ...
 * @param *Response $response
 */
$this('http')->post('/admin/spa/system/fieldset/update/:name', function (
  RequestInterface $request,
  ResponseInterface $response
) {
  //----------------------------//
  ...
  //----------------------------//
  // 2. Process Data
  $this('event')->call('system-fieldset-update', $data, $response);
