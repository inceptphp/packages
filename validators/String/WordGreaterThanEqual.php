...
namespace Incept\Package\Validator\String;
...
/**
 * Words Greater Than Equal Validator
 *
 * @vendor   Incept
 * @package  System
 * @standard PSR-2
 */
class WordGreaterThanEqual extends AbstractValidator implements ValidatorInterface
{
  /**
   ...
   */
  const LABEL = 'Words Greater Than Equal';
